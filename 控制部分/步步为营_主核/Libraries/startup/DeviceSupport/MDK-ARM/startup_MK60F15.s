...
__Vectors       DCD     __initial_sp  ; Top of Stack
                ...
                ; External Interrupts
                DCD     DMA0_IRQHandler  ; DMA channel 0/16 transfer complete interrupt
                DCD     DMA1_IRQHandler  ; DMA channel 1/17 transfer complete interrupt
                DCD     DMA2_IRQHandler  ; DMA channel 2/18 transfer complete interrupt
                DCD     DMA3_IRQHandler  ; DMA channel 3/19 transfer complete interrupt
                DCD     DMA4_IRQHandler  ; DMA channel 4/20 transfer complete interrupt
                DCD     DMA5_IRQHandler  ; DMA channel 5/21 transfer complete interrupt
                DCD     DMA6_IRQHandler  ; DMA channel 6/22 transfer complete interrupt
                DCD     DMA7_IRQHandler  ; DMA channel 7/23 transfer complete interrupt
                DCD     DMA8_IRQHandler  ; DMA channel 8/24 transfer complete interrupt
                DCD     DMA9_IRQHandler  ; DMA channel 9/25 transfer complete interrupt
                DCD     DMA10_IRQHandler  ; DMA channel 10/26 transfer complete interrupt
                DCD     DMA11_IRQHandler  ; DMA channel 11/27 transfer complete interrupt
                DCD     DMA12_IRQHandler  ; DMA channel 12/28 transfer complete interrupt
                DCD     DMA13_IRQHandler  ; DMA channel 13/29 transfer complete interrupt
                DCD     DMA14_IRQHandler  ; DMA channel 14/30 transfer complete interrupt
                DCD     DMA15_IRQHandler  ; DMA channel 15/31 transfer complete interrupt
