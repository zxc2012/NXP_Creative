...
typedef enum IRQn {
  ...
  DMA0_IRQn              = 0,                /**< DMA channel 0/16 transfer complete interrupt */
  DMA1_IRQn              = 1,                /**< DMA channel 1/17 transfer complete interrupt */
  DMA2_IRQn              = 2,                /**< DMA channel 2/18 transfer complete interrupt */
  DMA3_IRQn              = 3,                /**< DMA channel 3/19 transfer complete interrupt */
  DMA4_IRQn              = 4,                /**< DMA channel 4/20 transfer complete interrupt */
  DMA5_IRQn              = 5,                /**< DMA channel 5/21 transfer complete interrupt */
  DMA6_IRQn              = 6,                /**< DMA channel 6/22 transfer complete interrupt */
  DMA7_IRQn              = 7,                /**< DMA channel 7/23 transfer complete interrupt */
  DMA8_IRQn              = 8,                /**< DMA channel 8/24 transfer complete interrupt */
  DMA9_IRQn              = 9,                /**< DMA channel 9/25 transfer complete interrupt */
  DMA10_IRQn             = 10,               /**< DMA channel 10/26 transfer complete interrupt */
  DMA11_IRQn             = 11,               /**< DMA channel 11/27 transfer complete interrupt */
  DMA12_IRQn             = 12,               /**< DMA channel 12/28 transfer complete interrupt */
  DMA13_IRQn             = 13,               /**< DMA channel 13/29 transfer complete interrupt */
  DMA14_IRQn             = 14,               /**< DMA channel 14/30 transfer complete interrupt */
  DMA15_IRQn             = 15,               /**< DMA channel 15/31 transfer complete interrupt */
...
#include "system_MK60.h"            /* Device specific configuration file */
