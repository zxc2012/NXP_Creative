...
public class Board implements BoardInterface{
	...
	public  Space player1Start;
	public  Space player2Start;
	protected Space player1Space;
	protected Space player2Space;
	...
	protected static int a=0;//让他只选择一次
	...
	public Board(Two<Player> players) {
		this.players = players;
		  if(a!=1){
		  	System.out.println("先行方的位置:");
		  	System.out.println("1 - d1");
		  	System.out.println("2 - d7");
		  	...
		  	if(difficulty>0) {
		  		switch (difficulty){
		  			case 1: {
						this.player1Start = new Space("d1");
						this.player2Start = new Space("d7");
		 				this.player1Space = new Space("d1");
		  				this.player2Space = new Space("d7");

		  			}break;
		  			case 2: {
						this.player1Start = new Space("d7");
						this.player2Start = new Space("d1");
		  				this.player1Space = new Space("d7");
		  				this.player2Space = new Space("d1");
		  			}break;
		  			default:		
		  			{
					this.player1Start = new Space("d7");
	...
	public Board clone() {
		...
		cloneBoard.player1Start = this.player1Start;
		cloneBoard.player2Start = this.player2Start;
